...
<div id="settings_form">
  ...
  <form name="promo_form" id="promo_form" action="<?php echo osc_admin_base_url(true); ?>" method="POST" enctype="multipart/form-data" >
    ...
    <fieldset class="round3">
      <legend class="red round2"><?php _e('Countries & Regions Meta Settings','all_in_one'); ?></legend>
      <span class="cat-note"><a href="<?php echo osc_base_url() . 'oc-admin/index.php?page=settings&action=locations';?>"><i class="fa fa-pencil"></i><?php _e('Edit Locations','all_in_one'); ?></a></span>
      <span class="cat-note"><span class="note"><?php _e('Note', 'all_in_one'); ?>:</span> <?php _e('You can set custom meta title, description and keywords for countries and regions','all_in_one'); ?></span>

      <div class="clear" style="margin:12px 0;"></div>

      <div class="cat-list regions">
        <div class="cat-head round3">
          <div class="cat-elem id"><?php _e('ID', 'all_in_one'); ?></div>
          <div class="cat-elem name"><?php _e('Country Name', 'all_in_one'); ?></div>
        ...
        <?php seo_country_region_list(); ?>
      </div>
    </fieldset>

    <br /><br />
    <button name="theButton" id="theButton" type="submit" style="float: left;" class="btn btn-submit"><?php _e('Update locations', 'all_in_one');?></button>
  </form>

  <div class="clear"></div>
  <br /><br />

  <div class="warn"><?php _e('If you do not enter Meta details for region or country, default osclass settings are used.', 'all_in_one'); ?></div>
  <div class="warn"><?php _e('Do not enter more than 5 keywords per each location, it would be useless', 'all_in_one'); ?></div>
  ...
  <div class="warn"><?php _e('Meta description & title should contain some keyword for your region/country (it\'s name). This will secure that when user search this word, your site will be shown with your Meta Title & Description you entered here. Otherwise, Google - or other search engines - will generate own.', 'all_in_one'); ?></div>
  <div class="warn"><?php _e('When you are on listing page and you show region or country in title, region & country name <span class="underline">will not</span> be replaced by region/country meta title placed here', 'all_in_one'); ?></div>
  <div class="clear"></div>
  <br /><br />
