      ...
      <div class="link-list">
        ...
        <?php foreach( osc_has_links_seo() as $links ) { ?>
          ...
          <div class="link-row">
            ...
            <div class="link-elem del-link"><a href="<?php echo osc_base_url();?>oc-admin/index.php?page=plugins&action=renderplugin&file=all_in_one/links.php&what=delete&link_id=<?php echo $links['seo_link_id']; ?>" onclick="return confirm('<?php echo __('Are you sure you want to delete link', 'all_in_one') . ' #' . $links['seo_link_id'];?>?')"><i class="fa fa-trash"></i><?php _e('Delete', 'all_in_one'); ?></a></div>
          </div>
        <?php } ?>
      ...
      <div class="link-list rec">
        ...
        <?php foreach( osc_has_links_rec_seo() as $links ) { ?>
          ...
          <div class="link-row">
            ...
            <div class="link-elem refresh"><a href="<?php echo osc_base_url();?>oc-admin/index.php?page=plugins&action=renderplugin&file=all_in_one/links.php&what=refresh&link_id=<?php echo $links['seo_link_id']; ?>" title="<?php _e('Refresh status of this reciprocal link', 'all_in_one'); ?>"><i class="fa fa-refresh"></i><?php _e('Refresh', 'all_in_one'); ?></a></div>
            <div class="link-elem del-link"><a href="<?php echo osc_base_url();?>oc-admin/index.php?page=plugins&action=renderplugin&file=all_in_one/links.php&what=delete_rec&link_id=<?php echo $links['seo_link_id']; ?>" onclick="return confirm('<?php echo __('Are you sure you want to delete reciprocal link', 'all_in_one') . ' #' . $links['seo_link_id'];?>?')"><i class="fa fa-trash"></i><?php _e('Delete', 'all_in_one'); ?></a></div>
          </div>
        <?php } ?>
